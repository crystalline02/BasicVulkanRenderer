...
void Model::cleanUp(VkDevice device)
{
    ...
    vkDestroySampler(device, m_textureSampler, VK_NULL_HANDLE);
    vkDestroyImageView(device, m_textureImageView, VK_NULL_HANDLE);
    vkDestroyImage(device, m_textureImage, VK_NULL_HANDLE);
    vkFreeMemory(device, m_textureImageMemory, VK_NULL_HANDLE);
}
...
void Model::loadModel(const char* filename)
{
    ...
    m_appResources->createTexture("./textures/viking_room.png", m_textureImage, m_textureImageMemory, m_textureImageView);
    m_appResources->createSampler(m_textureSampler);
}
